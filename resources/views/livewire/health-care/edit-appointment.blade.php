<div class="lg:px-12 px-5 py-14">
    <h1 class="text-2xl mb-2">Edit Medical Appointment</h1>
    <form wire:submit="add" class="flex flex-col gap-5">
        ...
        <div class="flex flex-row gap-3 items-center">
            <span>Patient: </span> 
            <select disabled wire:model="patient_id" class="bg-gray-200 focus:border-[#3C5B6F] border-gray-200 border-2 outline-none px-3 py-2 rounded-full transition-all duration-150 ease-in-out w-full lg:w-[50%]">
